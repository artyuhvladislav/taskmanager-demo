...
Учебный демо-проект от HTML Academy для 20 потока профессионального онлайн‑курса «JavaScript. Архитектура клиентских приложений».

## Как пользоваться репозиторием

Первый вариант, это изучать коммиты [в веб-интерфейсе GitHub в master-ветке потока](https://github.com/htmlacademy-ecmascript/taskmanager-20).
...
## Обучение архитектуре приложений в ООП стиле 